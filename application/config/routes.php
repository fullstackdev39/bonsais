...
$route['api/login'] = "Webservice/login";
$route['api/register'] = "Webservice/registration";
$route['api/savetoken'] = "Webservice/savedevicetoken";
$route['api/resetpassword'] = "Webservice/resetpassword";
